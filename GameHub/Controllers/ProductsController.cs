...
namespace GameHub.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Name,Price,CategoryId,ReleaseYear")] Product product, IFormFile? Photo)
        {
            ...
            {
                 //upload the product photo if the user uploaded one
                 if(Photo != null)
                {
        ...
        //reusable method to upload a product photo with a unique name
        private static string UploadPhoto(IFormFile Photo)
        {
            //get the temp location of the photo
            var filePath = Path.GetTempFileName();

            //use globally unique identifier class (aka GUID) to assure we name the photo with a unique name
            ...
            //use a fileStream to copy the upload this folder
